...
export default function MenuNavigator({setIsOpen}) {
    return(
        <Navbar className="fixed w-full h-20 left-0 bottom-0 rounded-none p-0 flex items-center justify-center">
            <div className="w-full flex justify-around items-center gap-5">
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-postcard-heart" viewBox="0 0 16 16">
                ...
                <Button
                className="w-1/3 text-center flex justify-center max-w-20"
                variant="filled"
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" className="bi bi-view-stacked" viewBox="0 0 16 16">
